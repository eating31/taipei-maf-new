...
function Source() {
  let { title } = useParams();
  const [selectedTitle, setSelectedTitle] = useState('體育會');
  ...
  function onMouseOverCaptureHandler(e) {
    ...
    setData(taipei_city.find(each => each.id === e.target.id))
  }


  function onClickHandler(e) {

    //手機裝置不會觸發onMouseOverCaptureHandler事件
    const temp = taipei_city.find(each => each.id === e.target.id)
        ...
        <Row>
          <Col xs={12} md={3}>
            ...
            <ListGroup className='px-3 fs-5'>
              <ListGroup.Item action variant="secondary" onClick={() => setSelectedTitle('體育會')} active={selectedTitle === '體育會'}>
                臺北市各區體育會
              </ListGroup.Item>
              <ListGroup.Item action variant="secondary" onClick={() => setSelectedTitle('運動中心')} active={selectedTitle === '運動中心'}>
                臺北市各運動中心
              </ListGroup.Item>
              <ListGroup.Item action variant="secondary" onClick={() => setSelectedTitle('協會')} active={selectedTitle === '協會'}>
                本會各單項協會
              </ListGroup.Item>
              <ListGroup.Item action variant="secondary" onClick={() => setSelectedTitle('委員會')} active={selectedTitle === '委員會'}>
                本會各單項委員會
              </ListGroup.Item>
          ...
          <Col xs={12} md={9}>
            <p className='fs-3 text-center pt-sm-0 pt-3'>臺北市各{selectedTitle}</p>

            {selectedTitle === '體育會' && (
              <>
                <p className='fs-4 px-4'>臺北市{data.name}體育會</p>
                ...
                <Row>
                  <Col xs={12} md={6}>
                    <ul className='fs-4 py-2'>
                      ...
                      <li>臺北市體育總會羽球協會</li>
                      <li>臺北市體育總會籃網球協會</li>
                      <li>臺北市體育總會帕拉林匹克協會</li>
                      <li>臺北市體育總會幼兒體育協會</li>
                      <li>臺北市體育總會卡巴迪運動協會</li>
                      <li>臺北市體育總會養生運動協會</li>
                      <li>臺北市體育總會高爾夫協會</li>
                      <li>臺北市體育總會慢速壘球協會</li>
                      <li>臺北市體育總會漆彈運動協會</li>
                      ...
                      <li>臺北市體育總會跆拳道協會</li>
                      <li>臺北市體育總會山岳協會</li>
                      <li>臺北市體育總會民俗體育運動協會</li>
                      <li>臺北市體育總會聽障運動協會</li>
                      <li>臺北市體育總會木球協會</li>
                      <li>臺北市體育總會國術協會</li>
                      <li>臺北市體育總會太極棒運動氣功協會</li>
                    </ul>
                  </Col>
                  <Col xs={12} md={6}>
                    <ul className='fs-4 py-2'>
                      ...
                      <li>臺北市體育總會樂樂棒球協會</li>
                      <li>臺北市體育總會療癒瑜伽協會</li>
                      <li>臺北市體育總會跆拳道運動協會</li>
                      <li>臺北市體育總會象棋協會</li>
